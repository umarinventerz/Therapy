    ...
    <nav id="menuBar" class="navbar navbar-default lightHeader" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" ><img src="{{asset('img/logo.png')}}" alt="Therapi Aid"></a>
            </div>
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <h7>
                ...
                This Patient Portal is provided to you by your healthcare provider as a convenient means of communication. The Patient Portal is stored on a secure server and communications with the server are encrypted. However, be aware that no encryption method can be guaranteed to be unbreachable. Additionally, if you store screen shots of data on your computer or print out information from the Patient Portal, those copies would not be protected.
            </h7>
            <br>
            <br>
            <h7>
                Any communication through the Patient Portal is directed only to the therapist to which it is addressed. The therapist to which the communication is addressed may use the information you send to deliver care to you, but the content of the message will not automatically be included in or automatically be added to your electronic medical record. If you have any questions about your medical record, your patient portal account, or whether your communications through the Patient Portal will be included in your medical record, please contact your healthcare provider.
