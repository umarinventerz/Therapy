System.register(['@angular/core', '../../../../../jqwidgets-ts/angular_jqxdropdownlist'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, angular_jqxdropdownlist_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            AppComponent = (function () {
                ...
                __decorate([
                    core_1.ViewChild(angular_jqxdropdownlist_1.jqxDropDownListComponent), 
                    __metadata('design:type', angular_jqxdropdownlist_1.jqxDropDownListComponent)
                ], AppComponent.prototype, "myDropDownList", void 0);
                AppComponent = __decorate([
                    core_1.Component({
                        selector: 'my-app',
                        template: "<angularDropDownList></angularDropDownList>",
                        directives: [angular_jqxdropdownlist_1.jqxDropDownListComponent]
                    }), 
