...
declare module jqwidgets
{
    ...
    export interface DataAdapterOptions
    {
        ...
        loadError?: (jqXHR?: any, status?: string, error?: String) => void;
    ...
    export interface RangeSelectorOptions
    {
        ...
        height?: Size;
        labelFormat?: string;
        labelsFormatFunction?: (value: any) => string;
        labelPrecision?: number;
        moveOnClick?: boolean;
        markerRenderer?: (value: any, position: string) => String;
        markerPrecision?: number;
        majorLabelRenderer?: (value: any, date: any) => String;
        markerFormat?: string;
