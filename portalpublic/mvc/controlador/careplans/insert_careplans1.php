...
if(!isset($flag)){
    ...
    values ('".trim(urldecode($_POST['name_patient']))."','".trim(urldecode($_POST['last_name_patient']))."','".$_POST['patient_id']."', '".$_POST['discipline_id']."',"
         . "'".$_POST['from_poc']."','".$_POST['to_poc']."','".$_SESSION['user_id']."','".$_POST['diagnostic_id_poc']."',1,"
         . $_POST['id_eval'].",'".$_POST['company_id']."','".$_POST['template_id_Poc']."','".$_POST['editor_poc']."','".$therapista_signed."','".$fecha_firma."','".$latitude."','".$longitud."','".$therapista_signature."');";
    ...
    $sql_insert_document = "INSERT INTO tbl_documents (`id_type_document`,`id_type_person`,`id_table_relation`,`id_person`,`route_document`) "
            . " VALUES ('2','1',".$id_tbl_careplans.",'".$_POST['patients_id_poc_hidden']."','".$ruta1."')";
