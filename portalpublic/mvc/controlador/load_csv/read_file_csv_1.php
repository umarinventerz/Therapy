...
<script>
    function abrirVentana(discipline,cpt,type){        
        window.open('windows_report_amount.php?discipline='+discipline+'&cpt='+cpt+'&type='+type,'','width=900px,height=700px,noresize');       
    }
...
<body>
    ...
    <div class="container">
        ...
        <br/>
        <button type="button" class="btn btn-primary btn-lg" onclick="window.location='../../vista/load_csv/load_csv_form_1.php';">Return</button>
            </div>
