        ...
        swal({
          ...
          showLoaderOnConfirm: false,
            ...
            return false; 
                        ...
                        var campos_formulario = $("#form_gestion_patients").serialize();
...
<form id="form_gestion_patients" onSubmit="return Validar_Formulario_Gestion_Patients('form_gestion_patients');">      
    ...
    <div class="form-group row">                              
        ...
        <div class="form-group row">        
            <div class="col-lg-2"></div>
            <div class="col-sm-4 text-center">
                <input type="text" class="form-control" id="Pat_id" required="required" name="Pat_id" placeholder="PATIENT ID" style="text-align: center" onkeyup="Mayusculas(event, this)" value="<?php if(isset($_GET['Pat_id'])) { echo str_replace('|',' ',$_GET['Pat_id']); }?>">
...
<div class="col-sm-3">
    <input type="text" class="form-control" id="Last_name" name="Last_name" required="required" placeholder="Last Name" onkeyup="Mayusculas(event, this)" value="<?php if(isset($_GET['Last_name'])) { echo str_replace('|',' ',$_GET['Last_name']); }?>">
</div>   
                                            <label class="col-sm-2 form-control-label text-right"><font color="#585858">First Name</font></label>
<div class="col-sm-3"><input type="text" required="required" class="form-control" id="First_name" name="First_name" placeholder="First Name" onkeyup="Mayusculas(event, this)" value="<?php if(isset($_GET['First_name'])) { echo str_replace('|',' ',$_GET['First_name']); }?>"></div>
        </div>
...
<div class="col-sm-3"><input type="text" required="required" class="form-control" id="admision_date" name="admision_date" placeholder="Admision Date" onkeyup="Mayusculas(event, this)" value="<?php if(isset($_GET['admision_date'])) { echo str_replace('|',' ',$_GET['admision_date']); }?>"></div>   
...
<div class="col-sm-3"><input type="text" required="required" class="form-control" id="City" name="City" placeholder="City" onkeyup="Mayusculas(event, this)" value="<?php if(isset($_GET['City'])) { echo str_replace('|',' ',$_GET['City']); }?>"></div>   
...
<?php
                ...
                //print("<option value='".utf8_decode($row["Phy_id"])."' >".utf8_decode($row["Name"])." </option>");
                                                                if($row["Phy_id"]==$_GET['PCP']){
                                                                print("<option value='".$row["Phy_id"]."' selected>".$row["Name"]."</option>"); 
                                                            }else{
                                                                print("<option value='".$row["Phy_id"]."'>".$row["Name"]."</option>"); 
                                                                        }
                                                            }
...
<?php
                                 ...
                                 $conexion = conectar();
                                                            ...
                                                            while ($row=  mysqli_fetch_assoc($resultado)){                                                                                                   
               //print("<option value='".utf8_decode($row["Phy_id"])."' >".utf8_decode($row["Name"])." </option>");
                                                                if($row["Phy_id"]==$_GET['Ref_Physician_npi']){
                                                                print("<option value='".$row["Phy_id"]."' selected>".$row["Name"]."</option>"); 
                                                            }else{
                                                                print("<option value='".$row["Phy_id"]."'>".$row["Name"]."</option>"); 
                                                                        }
