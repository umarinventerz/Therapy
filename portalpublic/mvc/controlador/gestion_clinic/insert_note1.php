...
values ('".$_POST['discipline_id']."','".$snote."','".$onote."','".$anote."','".$pnote."',"
     . "'".$_POST['id_careplans']."',now(),now(),'".$_SESSION['user_id']."',".$signedNote.",".$dateSigned.",'".$Patient_name."',".$_POST['patients_id'].",".$_POST['duration'].",'".$_POST['visit_date']."');";
...
###############
 ...
 $insert_in_tbl_treatment_notes="INSERT INTO tbl_treatment_notes ( id_notes)
values ('".$id_tbl_note."');";
