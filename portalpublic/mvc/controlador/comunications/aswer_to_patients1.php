...
$date=date();
        $insert = " INSERT into response_to_comunications_portal_patients (Pat_id,tipe,content,form,send_to,aswer_to)
                    values ('".$form[0]['Pat_id']."','aswer','".$aswer."','".$form[0]['send_to']."','".$form[0]['form']."','".$id_questions."');";
