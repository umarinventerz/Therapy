...
<script src="../../../plugins/jquery-ui/jquery-ui.min.js"></script>
    ...
    <script type="text/javascript" language="javascript">
       ...
       function validar_formulario(){
                var parametros_formulario = $('#form_treatments_by_day_').serialize();
                     
                $("#resultado").empty().html('<img src="../../../images/loader.gif" width="30" height="30"/>');
                $("#resultado").load("../treatments_by_day_/grafico_treatments_by_day_.php?"+parametros_formulario);
...
<form id="form_treatments_by_day_"  onSubmit="return validar_formulario(this);">              
                <div class="row">
                    <div class="col-lg-12">                        
                        <h3 class="page-header">Treatments By Day </h3>                        
                    </div>
                </div>   
