...
<head>
    ...
    <script type="text/javascript" language="javascript">
       ...
       function validar_formulario(){
                var parametros_formulario = $('#form_physician_by_city').serialize();
                     
                $("#resultado").empty().html('<img src="../../../images/loader.gif" width="30" height="30"/>');
                $("#resultado").load("../physician_by_city/grafico_physician_by_city.php?"+parametros_formulario);
...
<form id="form_physician_by_city"  onSubmit="return validar_formulario(this);">              
                <div class="row">
                    <div class="col-lg-12">                        
                        <h3 class="page-header">Physician By City</h3>                        
                    </div>
                </div>   
