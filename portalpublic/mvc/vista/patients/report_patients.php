...
<head>
	...
	function selectAllFields(){
			...
			$("#fieldsShow").val("Pat_id,Patient_name,Sex,DOB,Guardian,Social,Address,City,Street,Zip,E_mail,Phone,Cell,Ref_Physician,Phy_NPI,Pri_Ins,Auth,Sec_INS,Auth_2,Ter_Ins,Auth_3,Mem_#,Grp_#,Intake_Agmts,Table_name,Thi_Ins");
		    }else{
			$("#fieldsShow").val("");     
		    }
           }
	...
	function updatePatient(pat_id,company,patient_name){		
		...
		window.location="report_patients.php";
	}
    </script>
</head>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
             <form class="form-horizontal" id="myForm" action="report_patients.php" method="post">
	    ...
	    &nbsp&nbsp           <input name='reset' type='button' value=" Reset " onclick= "window.location.href = 'report_patients.php';" class="btn btn-danger btn-lg">		    
			    </div>
			</div>			
		    </div>
		</form>              
