...
<body> 
    ...
    <div id="collapse1" class="panel-collapse collapse in" style="padding-top: 30px;padding-bottom: 10px;padding-right: 30px;padding-left: 30px;">
 	...
 	<?php if(!isset($_GET['name'])){?>
            ...
            <div class="col-lg-12">
                <div class="col-xs-1"></div>  <h3 class="page-header">Choose Patient from List</h3> <input type="hidden" value="" id="buttonReload" name="buttonReload">
            </div> 
            <div class="row">
            ...
            <div class="col-xs-3"> 
                ...
                <div class="col-lg-3">
                    <input id='find' name='find' type='submit' value=" Find " class="btn btn-success " style="height: 38px" onclick="findData();">
                    &nbsp&nbsp           <input name='reset' type='button' value=" Reset " onclick= "window.location.href = 'search.php';" style="height: 38px" class="btn btn-danger">
...
<tbody>
      ...
      $sqlpatientslist = " SELECT Pat_id, CONCAT(TRIM(Last_name),',',TRIM(First_name)) as Name,DOB,PCP,Pri_Ins,admision_date
FROM patients  ";
