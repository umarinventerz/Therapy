    ...
    <div class="panel-collapse collapse in" style="padding-top: 30px;padding-bottom: 10px;padding-right: 30px;padding-left: 30px;">
 	...
 	<?php if(!isset($_GET['name'])){?>
            ...
            <div class="row">
                ...
                <input style="height: 36px" id='find' name='find' type='submit' value=" Find " class="btn btn-success btn-lg" onclick="findData();">
                &nbsp&nbsp           <input style="height: 36px" name='reset' type='button' value=" Reset " onclick= "window.location.href = 'search_contacts.php';" class="btn btn-danger btn-lg">
