...
if(isset($_GET["Last_name_First_name"]) && $_GET["Last_name_First_name"] != null){ $Last_name_First_name = " and id = '".$_GET["Last_name_First_name"]."' "; } else { $Last_name_First_name = null; }
...
if(isset($_GET["type_patient"]) && $_GET["type_patient"] != null){ $type_patient = $_GET["type_patient"]; } else { $type_patient = 'true'; }
                ...
                if(isset($_GET["Ref_Physician"]) && $_GET["Ref_Physician"] != null){ 
                    ...
                    $Ref_Physician = " and Ref_Physician = '".$Ref_Physician_name."' ";
                ...
                if(isset($_GET["Pri_Ins"]) && $_GET["Pri_Ins"] != null){  
                    ...
                    $Pri_Ins = " and Pri_Ins = '".$Pri_Ins_insurance."' ";
                ...
                if(isset($_GET["Sec_INS"]) && $_GET["Sec_INS"] != null){  
                    ...
                    $Sec_INS = " and Sec_INS = '".$Sec_INS_insurance."' ";
                ...
                if(isset($_GET["Ter_Ins"]) && $_GET["Ter_Ins"] != null){                
                    ...
                    $Ter_Ins = " and Ter_Ins = '".$Ter_Ins_insurance."' "; 
...
$sql  = "SELECT * FROM patients WHERE true ".$Last_name_First_name.$Pat_id.$Sex.$DOB.$Guardian.$Social.$Address.$City.$Street.$Zip.$county.$E_mail.$Phone.$Cell.$pcp.$Ref_Physician.$Phy_NPI.$Pri_Ins.$Auth.$Sec_INS.$Auth_2.$Ter_Ins.$Auth_3.$Mem_N.$Grp_N.$Intake_Agmts.$active.';'; 
...
/*tablas_dinamicas_javascript*/            
        ...
        function Eliminar_patients(Pat_id,incrementador,accion){
                       ...
                       swal({
          title: "Confirmación",
          text: "Desea Eliminar el Registro N° "+Pat_id+"?",
          type: "warning",
