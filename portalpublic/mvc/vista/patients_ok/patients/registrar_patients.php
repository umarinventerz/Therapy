...
<!--<script src="../../../js/devoops_ext.js"></script>--> 
    ...
    function check_pat_id() {
        ...
        if(Pat_id==''){
            swal({
                title: "<h3><b>Por favor<b></h3>",
                type: "info",
                html: "<h4>Complete primeramente el campo</h4>",
...
/*tabladinamicasvalidacion*/
    ...
    swal({
                title: '<h4><b>Identificador del Paciente Repetido</b></h4>',                
                type: "error"
                });       
...
<div class="col-sm-3"><input type="checkbox" id="active" name="active" <?php if(isset($_GET['active']) && $_GET['active'] == '1') { echo 'checked'; }?>></div>   
                                            ...
                                            <div class="col-sm-3"><select id="Sex" name="Sex"><option value="">Seleccione..</option><option value="M" <?php if($_GET['Sex']=='M'){?> selected <?php } ?>>Masculino</option><option value="F" <?php if($_GET['Sex']=='F'){?> selected <?php } ?>>Femenino</option></select></div>
        </div>
...
<div class="col-sm-3"><input type="text" class="form-control" id="Phone" name="Phone" placeholder="Phone" onkeyup="Mayusculas(event, this)" value="<?php if(isset($_GET['Phone'])) { echo str_replace('|',' ',$_GET['Phone']); }?>"></div>
    ...
    <!--AGREGO COLUMNA DE LINEA TELEFONICA-->
            <div class="form-group row">                          
                ...
                <div class="col-sm-3"><select id="id_carriers" name="id_carriers"><option value="">Seleccione..</option></select></div>
    ...
    <?php echo $generar_input;?>
        ...
        <script>
            ...
            $(document).ready(function() {
                    ...
                    $('#Intake_Agmts').prop('readonly', false);
