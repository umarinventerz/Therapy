...
<script src="../../../plugins/jquery-ui/jquery-ui.min.js"></script>
    ...
    <script type="text/javascript" language="javascript">
       ...
       function validar_formulario(){
                var parametros_formulario = $('#form_discharge_patients_by_week').serialize();
                     
                $("#resultado").empty().html('<img src="../../../images/loader.gif" width="30" height="30"/>');
                $("#resultado").load("../discharge_patients_by_week/grafico_discharge_patients_by_week.php?"+parametros_formulario);
...
<form id="form_discharge_patients_by_week"  onSubmit="return validar_formulario(this);">              
                <div class="row">
                    <div class="col-lg-12">                        
                        <h3 class="page-header">Discharge Patients By Week</h3>                        
                    </div>
                </div>   
