...
$insert="INSERT into employee (`first_name`,`last_name`,`pay_to`,`social_security`,`adress`,`phone_number`,`email`,`Credentials`,`licence_number`,`finger_print`,`npi_number`,`caqh_number`,`status`,`type_salary`,`kind_employee`
...
,'".$fingerPrint."','".$npiNumber."','".$caqhNumber."','".$status."','".$typeSalary."'
			...
			<div class="box-content">
				...
				<form id="fileupload" role="form" enctype="multipart/form-data" class="form-horizontal"action="load_employee.php" method="post">
					...
					<div class="form-group" id="divCredentialsEmail">						
						...
						<div class="col-sm-4">
							<input type="text" onkeyup="unlockNextField('email',this.value,'');"  <?php echo $Credentials;?>" class="form-control" name="credentials" id="credentials" <?php echo $disabled;?>/>
						</div>
