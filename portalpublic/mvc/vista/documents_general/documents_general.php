...
if($(this).val() != '' && $(this).val() != null) {
    ...
    if(nombres_campos != ''){ 
       ...
       var formData = new FormData(form);                                                        
        ...
        $.ajax({
            url: "../../controlador/gestion_archivo/insertar_archivo.php",
            type: "POST",
            data: data, 
            processData: false,
            contentType: false,                                 
        ...
        function nuevo_documento(accion2,valor){           
            ...
            nuevaCelda.setAttribute('align','center');
            nuevaCelda.setAttribute('width','5%');                     
            nuevaCelda.innerHTML='<button type="button" class="btn btn-'+boton+'" id="btbuscar" onclick="'+accion+';">'+valor_boton+'</button>'; 
         
            autocompletar_select('id_type_persons','type_persons','tipo_persona'+posicionCampo,"Select id_type_persons, type_persons from tbl_doc_type_persons order by type_persons");                             
        ...
        <div class="row">
            ...
            <form id="myFormDocument" onSubmit="return Validar_Formulario_Documents();">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <a onclick="agregar_nuevo_registro('<form  id=\'form_type_documents\' name=\'form_type_documents\'><table align=\'center\'><tr><td align=\'left\'>Type Person: <select class=\'populate placeholder\' id=\'tipo_persona_agregar\' name=\'tipo_persona_agregar\'><option value=\'\'>--- SELECT ---</option></select></td></tr><tr><td>&nbsp;</td></tr><tr><td align=\'left\'>Type Document: <input class=\'form-control\' id=\'valor_tipo_documento\' name=\'valor_tipo_documento\'></td></tr></table></form>','mvc/controlador/type_persons_documents/insertar_type_persons_documents.php'); autocompletar_select('id_type_persons','type_persons','tipo_persona_agregar','Select id_type_persons, type_persons from tbl_doc_type_persons order by type_persons');LoadSelect2ScriptExt(function(){$('#tipo_persona_agregar').select2();});" style="cursor: pointer">New Type Document <img src="../../../images/agregar.png" width="20" height="20"/></a>
                    </div>
