...
<head>
    ...
    <script type="text/javascript" language="javascript">
       ...
       function validar_formulario(){
                var parametros_formulario = $('#form_patients_group_by_insurance').serialize();
                     
                $("#resultado").empty().html('<img src="../../../images/loader.gif" width="30" height="30"/>');
                $("#resultado").load("../patients_group_by_insurance/grafico_patients_group_by_insurance.php?"+parametros_formulario);
...
<form id="form_patients_group_by_insurance"  onSubmit="return validar_formulario(this);">              
                <div class="row">
                    <div class="col-lg-12">                        
                        <h3 class="page-header">Patients Group By Insurance</h3>                        
                    </div>
                </div>   
