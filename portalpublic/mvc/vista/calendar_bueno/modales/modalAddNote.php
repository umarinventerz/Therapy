                                   ...
                                   // $id_note=$_GET['id_note'];
                                    $id_note=7;
                                        $cpt_consult  = "Select N.*,N.start as start_date,N.end as end_date,C.cpt,L.name as location,concat(D.DiagCodeValue,', ',D.DiagCodeDescrip) as diagnosis from tbl_note_cpt_relation N left join cpt C ON(N.id_cpt=C.ID)"
                                                . "     LEFT JOIN tbl_location_appoiments L ON(N.location=L.id) LEFT JOIN diagnosiscodes D ON(N.id_diagnosis=D.DiagCodeId) WHERE N.id_note=".$id_note;
                                                ...
                                                <div class="btn-group">            
                                                    ...
                                                    <ul class="dropdown-menu pull-right">
                                                        <li align= "center" style="hidden-align: center">                                                    
                                                            <a onclick="modificarCpt(<?=$datos[0]['patient_id']?>,<?=$datos[0]['discipline_id']?>,'<?=$cpt_result[$j]['id_note_cpt_relation']?>',<?=$_GET['id_note']?>);" style="cursor: pointer;" class="ruta">Edit</a>
                                                        </li>
                                                        <li align= "center" style="hidden-align: center">
