                                        ...
                                        $.ajax({
                                                ...
                                                success: function(data){
                                                                    ...
                                                                    bootbox.confirm({
                                                                            ...
                                                                            callback: function (result) {
                                                                                if(result===true){
                                                                                        ...
                                                                                        bootbox.confirm({
                                                                                                message: "<b>¿Are you sure you want to create This EVAL?</b>",
                                                                                                buttons: {
                                                                                                    confirm: {
                                                                                                        label: 'Yes',
                                                                                                        className: 'btn-success'
                                                    ...
                                                    if(data.success==='reenvio'){
                                                        bootbox.alert(data.mensaje);                                                        
                                                        window.location="../../../mvc/vista/gestion_clinic?calendar=si&id_eval="+data.id;
                                                        //window.location="../../../mvc/vista/gestion_clinic?document=Evaluation&id="+data.id_appoiment+"&patient_id="+data.pat_id+"&disciplinas="+data.disciplina;
                                                    }
                                                }
