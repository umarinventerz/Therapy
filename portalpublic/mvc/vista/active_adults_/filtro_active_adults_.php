...
<head>
    ...
    <script type="text/javascript" language="javascript">
       ...
       function validar_formulario(){
                var parametros_formulario = $('#form_active_adults_').serialize();
                     
                $("#resultado").empty().html('<img src="../../../images/loader.gif" width="30" height="30"/>');
                $("#resultado").load("../active_adults_/grafico_active_adults_.php?"+parametros_formulario);
...
<form id="form_active_adults_"  onSubmit="return validar_formulario(this);">              
                <div class="row">
                    <div class="col-lg-12">                        
                        <h3 class="page-header">Active Adults </h3>                        
                    </div>
                </div>   
