...
<div class="col-lg-12">
                        ...
                        <table id="table_kidswork_therapy" class="table table-striped table-bordered" cellspacing="0" width="80%">
                    <thead>
                        <tr>    
                        <th  >ID TREAT</th>
                    ...
                    <tbody>
                        ...
                        while (isset($reporte[$i])) {
                            ...
                            if($reporte[$i]['campo_4']=='' || $reporte[$i]['campo_20']=='NULL'){
                                $action='<td align="center">  <button  type="button" style="font-size: 10px;padding: 1px 1px;border-radius: 50%;"  class="btn btn-success "  onclick="aceptar('.$reporte[$i]['id_treatments'].');">Inv</button></td>';

                            }else{
                               $action='<td align="center"> <button  type="button" style="font-size:10px;padding: 1px 1px;border-radius: 50%;"  class="btn btn-primary "  onclick="edit('.$reporte[$i]['id_treatments'].');">     Edit      </button> </td>';
