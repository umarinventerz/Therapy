...
if(isset($_GET["campo_90"]) && $_GET["campo_90"] != null){  $equidad1=1;} else { $campo_90 = 'true'; }
            ...
            if(isset($_GET["campo_6"]) && $_GET["campo_6"] != null){ $campo_6 = "pat_id = '".strtolower($_GET["campo_6"]."'"); } else { $campo_6 = 'true'; }
            if(isset($_GET["campo_7"]) && $_GET["campo_7"] != null){ $campo_7 = "insurance_name = '".strtolower($_GET["campo_7"]."'"); } else { $campo_7 = 'true'; }
            if(isset($_GET["campo_8"]) && $_GET["campo_8"] != null){ $campo_8 = "campo_8 = '".strtolower($_GET["campo_8"]."'"); } else { $campo_8 = 'true'; }
            if(isset($_GET["campo_9"]) && $_GET["campo_9"] != null){ $campo_9 = "T.campo_9 = '".strtolower($_GET["campo_9"]."'"); } else { $campo_9 = 'true'; }
            ...
            if(isset($_GET["campo_10"]) && $_GET["campo_10"] != null){ $campo_10 = "discipline = '".strtolower($_GET["campo_10"]."'"); } else { $campo_10 = 'true'; }
...
if($salida['kind_employee']!='Administrative') {
    ...
    $campo_9 = "campo_9 = '".strtolower($salida['employee_name']."'");
            ...
            if($equidad==2)
            {
                ...
                $campo_1 = "STR_TO_DATE(DOS , '%m/%d/%Y') > STR_TO_DATE('".$sql_1."','%m/%d/%Y')";
...
if($equidad1==1)
{
    ...
    $campo_90 ="STR_TO_DATE(DOS , '%m/%d/%Y') <= STR_TO_DATE('".$sql_1."','%m/%d/%Y')";
            ...
            $where = ' LEFT JOIN tbl_treatments T ON(T.id_treatments=TC.treatment_id) LEFT JOIN tbl_treatments_charge_status TCS ON(TCS.id_treatments_charge_status=TC.status) WHERE '.$id_treatments." and ".$campo_1." and ".$campo_90." and ".$campo_2." and ".$campo_3." and ".$campo_4." and ".$campo_5." and ".$campo_6." and ".$campo_7." and ".$campo_8." and ".$campo_9." and ".$license_number." and ".$campo_10." and ".$campo_11." and ".$campo_12." and ".$campo_13." and ".$campo_14." and ".$campo_15." and ".$campo_16." and ".$campo_17." and ".$campo_18." and ".$campo_19." and ".$campo_20." and ".$campo_21." and ".$campo_22." and ".$campo_23." and ".$campo_24." and ".$pay." and ".$adults_progress_notes." and ".$pedriatics_progress_notes.'';

            $sql  = "SELECT * FROM tbl_treatments_charges TC ".$joins.$where;

#$sql  = "SELECT * FROM tbl_treatments_charges tbl_".$joins.$where;
...
<div class="col-lg-12">
            ...
            <th style="width: 10px;">Inv. Date </th>
            <th style="width: 10px;">Pat</th>
            <th>Payee</th>
            ...
            <th>Status</th>
             ...
             echo '<td align="center"><font size="2">'.$reporte[$i]['id_treatments_charges'].'</font></td>';
             echo '<td align="center" ><font size="2">'.$reporte[$i]['DOS'].'</font></td>';
             echo '<td align="center" ><font size="2">'.$reporte[$i]['patient_name'].'</font></td>';

                            echo '<td align="center" ><font size="2">'.$reporte[$i]['patient_name'].'</font></td>';


             echo '<td align="center" ><font size="2">'.$reporte[$i]['insurance_name'].'</font></td>';


             echo '<td align="center" ><font size="2">'.$reporte[$i]['discipline'].'</font></td>';
                            echo '<td align="center" ><font size="2">'.$reporte[$i]['cpt_code'].'</font></td>';


                            echo '<td align="center" ><font size="2"><b>'.$reporte[$i]['charge'].'</b></font></td>';
                            echo '<td align="center" ><font size="2">'.$reporte[$i]['write_off'].'</font></td>';

                            echo '<td align="center"><font size="2">'.$reporte[$i]['pat_paid'].'</b></font></td>';

                            echo '<td align="center"><font size="2">'.$reporte[$i]['ins_paid'].'</b></font></td>';
                            echo '<td align="center"><font size="2"><b>'.$reporte[$i]['pat_balance'].'</b></font></td>';
                            echo '<td align="center"><font size="2"></b>'.$reporte[$i]['ins_balance'].'</b></font></td>';



                            echo '<td align="center"><font size="2">'.$reporte[$i]['status_treatments_charge'].'</font></td>';

                            echo '<td align="center"><font size="2">'.$reporte[$i]['status_paid'].'</font></td>';

                            echo '<td align="center"><img src='.$locations21.' height=25px width=25px onclick="aceptar('.$reporte[$i]['id_treatments'].');"> </img>
<img src='.$locations20.' height=25px width=25px onclick="edit('.$reporte[$i]['id_treatments'].');"> </img>
</td>';
