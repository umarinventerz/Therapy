        ...
        <form id="form_gestion_component" onSubmit="return Validar_Formulario_component('form_gestion_component');">       
            ...
            <div class="form-group row">
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <select id="category_id" name="category_id"><option value="">Seleccione..</option></select>
                    </div>
                </div>
            </div>
            <div class="form-group row">
...
autocompletar_radio('name','id','type_document','selector',null,null,null,null,'type_document');
autocompletar_radio('categorie_name','id_categories','tbl_component_categories','selector',null,null,null,null,'category_id');
