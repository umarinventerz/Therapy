...
<br>
                ...
                <div class="col-md-4">
                    <b>Discipline</b>
                            <select name='discipline[]' id='discipline' class="multiple form-control" multiple disabled="">
                ...
                <div class="col-md-4">
                    <b>Discipline</b>
                                <select  name='discipline[]' id='discipline' class="multiple form-control" multiple onchange="search_users();">
...
<b>Users</b>
                ...
                <div class="col-md-4">
                            ...
                            <b>Patients</b>
                <div class="col-md-4">
                            <select  name='patients_search[]' id='patients_search' class="multiple form-control" multiple>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div align="right"><button class="btn btn-primary" id="visit" onclick="consult_visit(<?=$_SESSION['user_id']?>);" >Create Visit</button></div>
                        <input type="hidden" name="discipline_id" id="discipline_id"/>
                        <input type="hidden" name="discipline_name" id="discipline_name"/>
                        <input type="hidden" name="nombre_paciente" id="nombre_paciente"/>
                        <input type="hidden" name="nombre_terapista" id="nombre_terapista"/>
                    </div>
                    <div class="modal-body">
                        ...
                        <form class="form-horizontal" id="crud-form">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <select id="type" style="width:100%;"name="type" class="populate placeholder">
...
<select style="width:100%;" name='patients' id='patients' class="populate placeholder">
...
<div class="col-md-6">
                                                ...
                                                <select  style="width:100%;" name='therapist' id='therapist' class="populate placeholder">
                                                    <option value=''>--- SELECT ---</option>
                                                    <option value="<?=$_SESSION['user_id']?>"><?php echo $respuesta['first_name']." ".$respuesta['last_name'] ?></option>
                                                </select>
</div>
...
<div class="col-md-6">
                                                ...
                                                <select style="width:100%;" name='therapist' id='therapist' class="populate placeholder">
                                                    <option value=''>--- SELECT ---</option>                 
                                                    <?php 
                                                    $sql  = "Select id,concat(Last_name,', ',First_name) as employee from employee WHERE kind_employee='Therapist'and assistant!='0' order by id";
                                                    $conexion = conectar(); 
                                                    $resultado = ejecutar($sql,$conexion);
                                                    while ($row=mysqli_fetch_array($resultado))  
                                                    {                                             
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                 <select  style="width:100%;" id="location" name="location" class="populate placeholder">
                                     <option value="">Seleccione</option>
                                     <?php
   ...
   <table class="table" border="0">
                                                    <tr>
                                                        ...
                                                        <input type="checkbox" id="mon" name="mon"/> 
                                                            Mon &nbsp
                                                            <b>From:</b> &nbsp&nbsp&nbsp
                                                                <select id="mon_hour" disabled="">
                                                        ...
                                                        <td>
                                                            <b>To:</b>&nbsp&nbsp<select id="mon_hour_to" disabled="">
                                                                <option value="01">01</option>
                                                                <option value="02">02</option>
                                                                <option value="03">03</option>
                                                                <option value="04">04</option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <input type="checkbox" id="tue" name="tue"/> 
                                                            Tue
                                                           &nbsp <b>From:</b>&nbsp&nbsp&nbsp<select id="tue_hour" disabled="">
                                                                <option value="01">01</option>
                                                                <option value="02">02</option>
                                                                <option value="03">03</option>
                                                                <option value="04">04</option>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="checkbox" id="wed" name="wed"/>Wed &nbsp
                                                            <b>From:</b>&nbsp&nbsp&nbsp<select id="wed_hour" disabled="">
                                                                <option value="01">01</option>
                                                                <option value="02">02</option>
                                                                <option value="03">03</option>
                                                                <option value="04">04</option>
                                                        ...
                                                        <td>
                                                            <b>To:</b>&nbsp&nbsp<select id="wed_hour_to" disabled="">
                                                                <option value="01">01</option>
                                                                <option value="02">02</option>
                                                                <option value="03">03</option>
                                                                <option value="04">04</option>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            &nbsp<b>From:</b>&nbsp&nbsp&nbsp<select id="thu_hour" disabled="">
                                                                <option value="01">01</option>
                                                                <option value="02">02</option>
                                                                <option value="03">03</option>
                                                                <option value="04">04</option>
                                                        ...
                                                        <td>
                                                            <b>To:</b>&nbsp&nbsp<select id="thu_hour_to" disabled="">
                                                                <option value="01">01</option>
                                                                <option value="02">02</option>
                                                                <option value="03">03</option>
                                                                <option value="04">04</option>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            &nbsp<b>From:</b>&nbsp&nbsp&nbsp<select id="fri_hour" disabled="">
                                                                <option value="01">01</option>
                                                                <option value="02">02</option>
                                                                <option value="03">03</option>
                                                                <option value="04">04</option>
                                                        ...
                                                        <td>
                                                            <b>To:</b>&nbsp&nbsp<select id="fri_hour_to" disabled="">
                                                                <option value="01">01</option>
                                                                <option value="02">02</option>
                                                                <option value="03">03</option>
                                                                <option value="04">04</option>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            &nbsp <b>From:</b>&nbsp&nbsp&nbsp<select id="sat_hour" disabled="">
                                                                <option value="01">01</option>
                                                                <option value="02">02</option>
                                                                <option value="03">03</option>
                                                                <option value="04">04</option>
                                                        ...
                                                        <td>
                                                            <b>To:</b>&nbsp&nbsp<select id="sat_hour_to" disabled="">
                                                                <option value="01">01</option>
                                                                <option value="02">02</option>
                                                                <option value="03">03</option>
                                                                <option value="04">04</option>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            &nbsp <b>From:</b>&nbsp&nbsp&nbsp<select id="sun_hour" disabled="">
                                                                <option value="01">01</option>
                                                                <option value="02">02</option>
                                                                <option value="03">03</option>
                                                                <option value="04">04</option>
                                                        ...
                                                        <td>
                                                            <b>To:</b>&nbsp&nbsp<select id="sun_hour_to" disabled="">
                                                                <option value="01">01</option>
                                                                <option value="02">02</option>
                                                                <option value="03">03</option>
                                                                <option value="04">04</option>
                                                    ...
                                                    <tr>
                                                        <td>For the next<input id="next" name="next" type="number"  class="form-control" /></td>
                                                        <td>Frecuently
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                 <select style="width:50%;" id="attendance" name="attendance" class="populate placeholder">

                                     <?php
                                            $sql  = "SELECT * FROM tbl_status_appoiments ORDER BY id DESC";
                                            $conexion = conectar();
                                            $resultado = ejecutar($sql,$conexion);
                                            while ($row=mysqli_fetch_array($resultado)) 
                                            {	
    ...
    <script type="text/javascript">
            ...
            function consult_visit(user_activo){
                var patients=$("#patients").val();
                var user_modal=$("#therapist").val();
                if(patients ===''){
                    bootbox.alert('Cant create visit without a Patient Assign to Appoitment');
                    return false;
                }
         //       if(user_activo != user_modal){                    
           //         bootbox.alert('You are not the therapist for this Appoitment');
                    //return false;
           //     }
                $.ajax({
                    url: '../../../mvc/controlador/calendar/consult_visit.php',
                    data: {                                                                                        
                        id_date: $('#id_date').val(),
                    ...
                    success: function(data){
                        if(data.success!=='reenvio'){
                           create_visit(user_activo);
                        }else{                            
                            bootbox.confirm({
                                ...
                                callback: function (result) {
                                    if(result===true){
                                        //evaluaciones
                                        if(data.ruta==='evaluacion'){
                                            window.location="../../../mvc/vista/gestion_clinic?calendar=si&id_eval="+data.id; 
                                        }else{
                                            //ruta de theraphy
                                            window.location="../../../mvc/vista/gestion_clinic?note=si&id_note="+data.id;
                                            
                                        }
                                    }else{
                                        setTimeout('devolver_calendario()',1000);
                                    }
                                }
                            }); 
                        }
            ...
            function create_visit(user_activo){
              ...
              //  }
                                ...
                                var type=$("#type").val();
                if(type==='2'){
                    var mensaje='<div align="center">Prescriptions<input type="radio" name="type_appoiment" id="evaluation">\nEvaluation <input type="radio" checked="true" name="type_appoiment" id="evaluation"> \n\
                                   Therapy <input type="radio"  name="type_appoiment" id="therapy"></div>';
                }else if(type==='15'){
                    mensaje='<div align="center">Prescriptions<input type="radio" name="type_appoiment" id="evaluation">\n\ Evaluation <input type="radio" name="type_appoiment" id="evaluation"> \n\
                                   Therapy <input type="radio" checked="true" name="type_appoiment" id="therapy"></div>';
                }else{
                   mensaje='<div align="center">Evaluation <input type="radio" name="type_appoiment" id="evaluation"> \n\
                                   Therapy <input type="radio" name="type_appoiment" id="therapy"></div>'; 
                }
                            ...
                            if(result===true){
                                ...
                                if(evaluation==='si'){
                                    $.ajax({
                                        ...
                                        url: '../../../mvc/controlador/calendar/gestion_eval_jorgito.php',
                                        data: {
                                            insertar: 'no',
                                            pat_id: $('#patients').val(),
                                            diciplina:$("#discipline_id").val(),
                                            id_date: $('#id_date').val(),
                                        },
                                        type: 'POST',
                                        async:false,
                                                ...
                                                bootbox.confirm({
                                                    ...
                                                    callback: function (result) {
                                                        if(result===true){
                                                            ...
                                                            $.ajax({
                                                                url: '../../../mvc/controlador/calendar/gestion_eval.php',
                                                                data: {
                                                                    id_date: $('#id_date').val(),
                                                                    id_calendar: $('#id_calendar').val(),
                                                                    pat_id: $('#patients').val(),
                                                                    therapista_id:$('#therapist').val(),
                                                                    name_patients:$('#nombre_paciente').val(),
                                                                    type:$('#type').val(),
                                                                    subject:$('#subject').val(),
                                                                    ...
                                                                    id_preescription:data.id_preescription,
                                                                ...
                                                                success: function(data){
                                                                    if(data.success){
                                                                        ...
                                                                        window.location="../../../mvc/vista/gestion_clinic?calendar=si&id_eval="+data.id_eval;
                                                                    }else{
                                                                        bootbox.alert(data.mensaje);
                                                                        setTimeout('devolver_calendario()',4000);
                                                                    }
                                                                }
                                    ...
                                    //codigo para terapista
                                    $.ajax({
                                        url: '../../../mvc/controlador/calendar/gestion_note.php',
                                        data: {                                                
                                            insertar: 'no',
                                            pat_id: $('#patients').val(),
                                            diciplina:$("#discipline_id").val(),                                            
                                                                            ...
                                                                            if(result===true){
                                                                                    $.ajax({
                                                                                            ...
                                                                                            success: function(data){
                                                                                                if(data.success){
                                                                                                    bootbox.alert(data.mensaje);
                                                                                                    window.location="../../../mvc/vista/gestion_clinic?note=si&id_note="+data.id_note;
                                                                                                }else{                                                                                
                                                                                                    bootbox.alert(data.mensaje);
                                                                                                    setTimeout('devolver_calendario()',4000);
                                                                                                }
                                                                    ...
                                                                    bootbox.confirm({
                                                                            ...
                                                                            callback: function (result) {
                                                                                if(result===true){
                                                                                        ...
                                                                                        bootbox.confirm({
                                                                                                message: "<b>¿Are you sure you want to create This NOTE?</b>",
                                                                                                buttons: {
                                                                                                    confirm: {
                                                                                                        label: 'Yes',
                                                                                                        className: 'btn-success'
 ...
 //date: currentEvent.date.split(' ')[0]  + ' ' +  getTime(),
            ...
            $(document).ready(function() {
                ...
                $("#modalAddEvaluation").modal({show:false});
			...
			$('#star_time').appendDtpicker({"inline": false});
                ...
                $(function(){
                        ...
                        dayClick: function(date, event, view) {                            
                            ...
                            if($("#edit_none").val()==='si'){                                
                                ...
                                modal({
                                    ...
                                    title: 'Add appointments ('+ currentDate + ')'
                                },date);
                            }
                        },
                    ...
                    function modal(data,date) { 
                        ...
                        $("#nombre_paciente").val(data.event ? data.event.title : '');
                        $("#discipline_name").val(data.event ? data.event.disciplina_name : '');
                        $("#nombre_terapista").val(data.event ? data.event.employee : '');
                        if(data.event) {
