    ...
    <script>
        ...
        function validar_form_note(accion){
            ...
            if(error == 0){
                ...
                if(accion==='insertar'){
                    var url="../gestion_clinic/insert_note.php";
                    var mensaje='Saved';

                }else{
                    url="../gestion_clinic/edit_note.php";
                    mensaje='Updated';
                }
        ...
        <form id="formNote" <?php if(isset($_GET['note'])){?>onsubmit="return validar_form_note('edit');"<?php }else{?> onsubmit="return validar_form_note('insertar');"<?php } ?> enctype="multipart/form-data">
                ...
                <div >
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" name="id_careplans" id="id_careplans" value="<?=$datos_good[0]['id_careplans']?>">
                            <input type="hidden" name="patients_id" id="patients_id" value="<?=$datos_good[0]['patient_id']?>">
                            <input type="hidden" name="discipline_id" id="discipline_id" value="<?=$datos_good[0]['discipline_id']?>">
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 withoutPadding">
                                <?php   echo $datos_good[0]['First_name'].' '.$datos_good[0]['Last_name']."<b> ( ".$datos_good[0]['Pat_id'].")</b>"?>
                            </div>
                        ...
                        <div class="row" style="margin-top: 15px;">
                            ...
                            <div class="col-lg-4 withoutPadding">
                                ...
                                $sql_evaluations  = "SELECT *  FROM tbl_visits tv "
                                    ...
                                    . "WHERE tv.id='".$datos_good[0]['visit_id']."' ";
                                $resultado = ejecutar($sql_evaluations,$conexion);
                            ...
                            <div class="col-lg-3 withoutPadding">
                                <select name="duration" id="duration">
                                    <option value="15" <?php if($datos_good[0]['minutes']==15){?>selected=""<?php }?>>15</option>
                                    <option value="30" <?php if($datos_good[0]['minutes']==30){?>selected=""<?php }?>>30</option>
                                    <option value="45" <?php if($datos_good[0]['minutes']==45){?>selected=""<?php }?>>45</option>
                                    <option value="60" <?php if($datos_good[0]['minutes']==60){?>selected=""<?php }?>>60</option>
                        ...
                        <div class="row" >
                            ...
                            <div  class="col-lg-4">
                                <?php echo $datos_good[0]['first_name']." ".$datos_good[0]['last_name'].'('.$datos_good[0]['npi_number'].")"?>
                            </div>
                            ...
                            <div class="col-lg-4 withoutPadding" >
                                &nbsp;&nbsp;  <?php echo $datos_good[0]['Description'].' ( '.$datos_good[0]['Name'].' )'?>
                            </div>
            ...
            <br><hr>
             ...
             <div class="row" style="margin-top: 15px;">
                                ...
                                <div class="col-lg-1">
                                    <input type="checkbox" id="signedNote" name="signedNote" style="width: 15px;height: 15px;" value="1" class="form-control" <?php if($datos_good[0]['user_signed']==1){?>checked=""<?php } ?>>
                                </div>
                                <div class="col-lg-5">
                                    <input type="text" id="dateSigned" name="dateSigned" class="form-control" placeholder="Signed Date" value="<?=$datos_good[0]['user_signed_date']?>">
                                </div>
                            </div>
            ...
            <div class="row card_footer">
                ...
                <div class="col-sm-offset-1 col-sm-2 mg-top-sm">
                    <button type="button" class="btn btn-danger" onclick="cancelar(<?=$datos_good[0]['patient_id']?>,<?=$datos_good[0]['discipline_id']?>)"><i class="fa fa-times"></i>&nbsp;Cancel</button>
                </div>
