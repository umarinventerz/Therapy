...
$i = 0;      
while($datoss = mysqli_fetch_assoc($resultado_departaments)) {
    $reporte_departaments[$i] = $datoss;
    $i++;
}
...
$i = 0;      
while($datoss = mysqli_fetch_assoc($resultado_tabs)) {
    $reporte_tabs[$i] = $datoss;
    $i++;
}
