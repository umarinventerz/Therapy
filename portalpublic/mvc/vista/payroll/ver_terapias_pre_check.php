...
<?php
$conexion = conectar();
    $sql  = "SELECT * FROM tbl_pre_check_treatments ct "
        . " LEFT JOIN tbl_treatments t ON t.id_treatments = ct.id_treatments "
        . " left join employee emp on t.license_number = emp.licence_number
            ...
            WHERE id_pre_check =".sanitizeString($conexion, $_GET['id_pre_check']).";";
...
<div class="col-lg-12">&nbsp;</div>	
        ...
        <?php                         
            ...
            $sql_extra_pay = "SELECT * FROM tbl_pre_check_extra_pay pcep "
                        . " LEFT JOIN tbl_extra_pay ep ON ep.id_extra_pay = pcep.id_extra_pay "
                        . " WHERE pcep.id_pre_check = ".sanitizeString($conexion, $_GET['id_pre_check']);

            $data_extra_pay = ejecutar($sql_extra_pay,$conexion);                
            $reporte_extra_pay = array();            
            $k = 0;      
            while($datos = mysqli_fetch_assoc($data_extra_pay)) {            
                $reporte_extra_pay[$k] = $datos;
           ...
           while (isset($reporte_extra_pay[$y])){ 
               ...
               $i++;
                        ...
                        $datos_result .= '<tr><td colspan="9" align="right"><b>Total:</b></td>';
