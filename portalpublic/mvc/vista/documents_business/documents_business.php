    ...
    <script type="text/javascript">
       ...
       $(document).ready(function() {
        ...
        if($('#id_departaments'+p).val() == ''){
            ...
            nombres_campos += "<table align='center'  width='400px'><tr><td align='left'> * "+"Departamento N° "+p+"</td></tr></table>";
            ...
            departaments += $("#id_departaments"+p).val()+"|";
                ...
                if($('#tipo_documento'+p).val() == ''){
                    ...
                    nombres_campos += "<table  border='0' width='400px'><tr><td align='left'> * "+"Tipo Documento N° "+p+"</td></tr></table>";
                ...
                if($('#version'+p).val() == ''){
                    ...
                    nombres_campos += "<table  border='0' width='400px'><tr><td align='left'> * "+"Versión N° "+p+"</td></tr></table>";
...
if($(this).val() != '' && $(this).val() != null) {
             	...
             	if(file_size>909715200) {
                    ...
                    nombres_campos += "<table align='center'  width='400px'><tr><td align='left'> * "+"El Archivo N° "+p+" no puede ser mayor a 10MB</td></tr></table>";
                     ...
                     switch($(this).val().substring($(this).val().lastIndexOf('.') + 1).toLowerCase()){
                        ...
                        nombres_campos += "<table align='center'  width='400px'><tr><td align='left'> * "+"El Archivo N° "+t+" solo puede ser formato CSV</td></tr></table>";
                        ...
                        nombres_campos += "<table align='center'  width='400px'><tr><td align='left'> * "+"Falta incluir un archivo en la fila N° "+t+" </td></tr></table>";
    ...
    if(nombres_campos != ''){ 
       ...
       var formData = new FormData(form);                                                        
        ...
        function nuevo_documento(accion2,valor){           
            ...
            nuevaCelda=nuevaFila.insertCell(-1);  
            nuevaCelda.setAttribute('align','center');
            nuevaCelda.setAttribute('width','10%');
            nuevaCelda.setAttribute('heigth','1px');
            nuevaCelda.innerHTML='<textarea style="height: 35px" class="form-control" name="description'+posicionCampo+'" id="description'+posicionCampo+'" onkeyup="Mayusculas(event, this)"></textarea>';
        ...
        <div class="row">
            ...
            <div class="col-lg-12 text-center">
                ...
                if($_SESSION['user_type'] <> 1  ){
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <button class="btn btn-info" id="boton_td" type="button" onclick="cargar_result('resultado_documents_business','../type_documents/result_type_documents.php');cambiar_color('boton_td','#01A9DB');"><img src="../../../images/lupa.png" width="20" height="20"/>Documents Type</button>
...
?>
            ...
            <form id="myFormDocument" onSubmit="return Validar_Formulario_Documents();">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header">Load Documents Business</h3>
                   </div>
                </div>
                ...
                <table  class="table"  align="center" id="nuevos_registro_documento" cellpadding="0" cellspacing="0"></table>
            ...
            <br>       
                ...
                <div class= col-lg-12">
                    ...
                    <div class="col-sm-4">
                    <button style="width:100%" type="submit" class="btn btn-primary text-left">Load</button>
                    </div>
                    <div class="col-sm-4"></div>
