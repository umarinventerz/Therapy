...
<div class="col-lg-12">
                    ...
                    <thead>
                        <tr>    
                        <th style="width:10px"; >ID TREAT</th>
                    ...
                    <tbody>
                        ...
                        while (isset($reporte[$i])) {
                            ...
                            if($reporte[$i]['campo_4']=='' || $reporte[$i]['campo_20']=='NULL'){
                                $action='<td align="center">  <button  type="button" style="height=25px;width=25px"  class="btn btn-success btn-block"  onclick="aceptar('.$reporte[$i]['id_treatments'].');">Convert</button></td>';

                            }else{
                               $action='<td align="center">See the report billing  </td>';
 ...
 echo '<td align="center"><font size="2"><b>'.$reporte[$i]['id_treatments'].'</b></font></td>';
             ...
             echo '<td align="center"><img src='.$locations18.' height=25px width=25px> </img></td>';
