...
$(document).ready(function() {
    ...
    $('#autorizations_jorgito').DataTable({
        dom: 'Bfrtip',
    ...
    <div id="collapse1" class="panel-collapse collapse in" style="padding-top: 30px;padding-bottom: 10px;padding-right: 30px;padding-left: 30px;">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
				...
				<div class="col-lg-2">
				    <label for="inputText" class="control-label">Discipline:<input type="hidden" id="disciplineUpdate" name="disciplineUpdate" value="<?php echo $_POST['disciplineUpdate'];?>"></label>
				...
				<div class="col-lg-2">
				    <label for="inputText" class="control-label">cpt:<input type="hidden" id="cptUpdate" name="cptUpdate" value="<?php echo $_POST['cptUpdate'];?>"></label>
					    ...
					    <option value='' selected>--- SELECT ---</option>
						  <?php 
						  $sqlcpt = "Select Discipline,type,cpt  from cpt where type='TX' order by cpt";						  				
				...
				<div class="col-lg-2">
				    <label for="inputText" class="control-label">Insurance:<input type="hidden" id="insuranceUpdate" name="insuranceUpdate" value="<?php echo $_POST['insuranceUpdate'];?>"></label>
                    ...
                    <div class="col-lg-2">
                        ...
                        <label for="inputText" class="control-label ">Auth Number:<input type="hidden" id="auth_numberUpdate" name="auth_numberUpdate" value="<?php echo $_POST['auth_numberUpdate'];?>"></label>
				...
				<div class="form-group">
				    ...
				    <label  for="inputText" class="control-label ">Auth Start:
                        <input type="hidden" id="auth_startUpdate" name="auth_startUpdate" value="<?php echo $_POST['auth_startUpdate'];?>"></label>

					    <?php if((!isset($_POST['auth_start']) || $_POST['auth_start']=='') || ($_POST['action'] == 'update' && $_POST['auth_startUpdate'] == 'no')){?>
					    <input type="date" name='auth_start' id='auth_start' class='form-control' style="height:35px;" <?php echo $disabled;?> required>
					    <?php
						}else{						  
					    ?>
				    ...
				    <label for="inputText" class="control-label ">Auth Thru:<input type="hidden" id="auth_thruUpdate" name="auth_thruUpdate" value="<?php echo $_POST['auth_thruUpdate'];?>"></label>

					    <?php if((!isset($_POST['auth_thru']) || $_POST['auth_thru']=='') || ($_POST['action'] == 'update' && $_POST['auth_thruUpdate'] == 'no')){?>
					    <input type="date" name='auth_thru' id='auth_thru' class='form-control' style="height:35px;width: 100%" <?php echo $disabled;?> required>
					    <?php
						}else{						
					    ?>
                    ...
                    <div class="col-lg-2">
				    <label for="inputText" class="control-label ">Received by:<input type="hidden" id="receivedUpdate" name="receivedUpdate" value="<?php echo $_POST['receivedUpdate'];?>"></label>
                    ...
                    <div class=" col-lg-3">
                        ...
                        <input style="height:35px;" name='reset' type='button' value=" Reset " onclick= "window.location.href = 'load_authorizations.php';" class="btn btn-warning ">
            ...
            <div class="col-md-12">
			<table   id="autorizations_jorgito"class="table">
									<thead>
            <tr>	
		<th>Patient ID</th>			
                <th>NAME</th>
		...
		<th>File Route</th>
                <th>Delete</th>
					...
					$query01 = " select * from authorizations WHERE status = 1 order by TIMESTAMP desc
					";
					...
					while($row = mysqli_fetch_array($result01,MYSQLI_ASSOC)){
						...
						echo '<tr>	 						
							...
							<td>'.$status.'</td>
							<td><a onclick="window.open(\''.$row['route_file'].'\',\'\',\'width=900px,height=700px,noresize\');">Documents</a></td>
							<td><div id="result_d'.$row['Pat_id'].'"><button  style="height:35px;" type="button" class="btn btn-danger " onclick="deleteAuthorizations(\''.$row['Patient_name'].'\',\''.$row['Pat_id'].'\',\''.$row['Discipline'].'\',\''.$row['Auth_#'].'\');">Delete</button></div></td>										
						</tr>';
					}
