...
<script  language="JavaScript" type="text/javascript">
        ...
        function update_table(){
            ...
            campos_formulario='test';


            $.ajax({
                type: "POST",
                url: '../../controlador/nuevos_reportes/report_amount_web.php',
                dataType: 'JSON',
                success: function (data) {
location.reload();
                    swal("Good", "Reload the page", "success");
...
?><!--
 ...
 <button type="button"  onclick="update_table()"> <img height="30 %" width="30 %" src="../../../images/actualizar.png" > Update</button>
